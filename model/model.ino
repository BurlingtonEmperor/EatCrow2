...
const long interval = 27000; // interval is set to 27s because otherwise the Serial buffer clogs up (the ACTUAL interval is less than half of this one, so realistically it's only about 9s)
